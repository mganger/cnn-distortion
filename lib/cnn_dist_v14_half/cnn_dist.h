...
struct cnn_dist_v14 {
	...
	void operator()(float* x, float* y, int L) {
		...
		for (int k = 0; k < 2; k++) {
			...
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 1, L-0, 1, 1.0, &w_layer_0[k][0][0], 1, &x_odd[0-offset][0], MAX_CH, beta, &x_even[0][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*0;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 1, L-0, 1, 1.0, &w_layer_1[k][0][0], 1, &x_even[0-offset][0], MAX_CH, beta, &x_odd[0][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*32;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-32, 1, 1.0, &w_layer_2[k][0][0], 4, &x_odd[32-offset][0], MAX_CH, beta, &x_even[32][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*16;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-48, 4, 1.0, &w_layer_3[k][0][0], 4, &x_even[48-offset][0], MAX_CH, beta, &x_odd[48][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*8;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-56, 4, 1.0, &w_layer_4[k][0][0], 4, &x_odd[56-offset][0], MAX_CH, beta, &x_even[56][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*4;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-60, 4, 1.0, &w_layer_5[k][0][0], 4, &x_even[60-offset][0], MAX_CH, beta, &x_odd[60][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*2;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-62, 4, 1.0, &w_layer_6[k][0][0], 4, &x_odd[62-offset][0], MAX_CH, beta, &x_even[62][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*1;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-63, 4, 1.0, &w_layer_7[k][0][0], 4, &x_even[63-offset][0], MAX_CH, beta, &x_odd[63][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 6, L-63, 4, 1.0, &w_layer_8[k][0][0], 6, &x_odd[63-offset][0], MAX_CH, 1.0, &x_even[63][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 6, L-63, 6, 1.0, &w_layer_9[k][0][0], 6, &x_even[63-offset][0], MAX_CH, 1.0, &x_odd[63][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 6, L-63, 6, 1.0, &w_layer_10[k][0][0], 6, &x_odd[63-offset][0], MAX_CH, 1.0, &x_even[63][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 6, L-63, 6, 1.0, &w_layer_11[k][0][0], 6, &x_even[63-offset][0], MAX_CH, 1.0, &x_odd[63][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-63, 6, 1.0, &w_layer_12[k][0][0], 4, &x_odd[63-offset][0], MAX_CH, 1.0, &x_even[63][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*16;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-79, 4, 1.0, &w_layer_13[k][0][0], 4, &x_even[79-offset][0], MAX_CH, beta, &x_odd[79][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*8;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-87, 4, 1.0, &w_layer_14[k][0][0], 4, &x_odd[87-offset][0], MAX_CH, beta, &x_even[87][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*4;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-91, 4, 1.0, &w_layer_15[k][0][0], 4, &x_even[91-offset][0], MAX_CH, beta, &x_odd[91][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*2;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 4, L-93, 4, 1.0, &w_layer_16[k][0][0], 4, &x_odd[93-offset][0], MAX_CH, beta, &x_even[93][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*1;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 1, L-94, 4, 1.0, &w_layer_17[k][0][0], 1, &x_even[94-offset][0], MAX_CH, beta, &x_odd[94][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*2;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-96, 1, 1.0, &w_layer_18[k][0][0], 2, &x_odd[96-offset][0], MAX_CH, beta, &x_even[96][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*1;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 1, L-97, 2, 1.0, &w_layer_19[k][0][0], 1, &x_even[97-offset][0], MAX_CH, 1.0, &x_odd[97][0], MAX_CH);
		}
