...
struct cnn_dist_v11 {
	...
	void operator()(float* x, float* y, int L) {
		...
		for (int k = 0; k < 2; k++) {
			...
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-64, 1, 1.0, &w_layer_0[k][0][0], 3, &x_odd[64-offset][0], MAX_CH, beta, &x_even[64][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*32;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-96, 3, 1.0, &w_layer_1[k][0][0], 3, &x_even[96-offset][0], MAX_CH, beta, &x_odd[96][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*16;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-112, 3, 1.0, &w_layer_2[k][0][0], 3, &x_odd[112-offset][0], MAX_CH, beta, &x_even[112][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*8;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-120, 3, 1.0, &w_layer_3[k][0][0], 2, &x_even[120-offset][0], MAX_CH, beta, &x_odd[120][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-120, 2, 1.0, &w_layer_4[k][0][0], 3, &x_odd[120-offset][0], MAX_CH, 1.0, &x_even[120][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-120, 3, 1.0, &w_layer_5[k][0][0], 3, &x_even[120-offset][0], MAX_CH, 1.0, &x_odd[120][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-120, 3, 1.0, &w_layer_6[k][0][0], 2, &x_odd[120-offset][0], MAX_CH, 1.0, &x_even[120][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*64;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-184, 2, 1.0, &w_layer_7[k][0][0], 2, &x_even[184-offset][0], MAX_CH, beta, &x_odd[184][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*32;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-216, 2, 1.0, &w_layer_8[k][0][0], 2, &x_odd[216-offset][0], MAX_CH, beta, &x_even[216][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*16;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-232, 2, 1.0, &w_layer_9[k][0][0], 2, &x_even[232-offset][0], MAX_CH, beta, &x_odd[232][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*8;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-240, 2, 1.0, &w_layer_10[k][0][0], 2, &x_odd[240-offset][0], MAX_CH, beta, &x_even[240][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-240, 2, 1.0, &w_layer_11[k][0][0], 3, &x_even[240-offset][0], MAX_CH, 1.0, &x_odd[240][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-240, 3, 1.0, &w_layer_12[k][0][0], 3, &x_odd[240-offset][0], MAX_CH, 1.0, &x_even[240][0], MAX_CH);
		}
		...
		for (int k = 0; k < 1; k++) {
			int offset = (0-k)*0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 2, L-240, 3, 1.0, &w_layer_13[k][0][0], 2, &x_even[240-offset][0], MAX_CH, 1.0, &x_odd[240][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*128;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-368, 2, 1.0, &w_layer_14[k][0][0], 3, &x_odd[368-offset][0], MAX_CH, beta, &x_even[368][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*64;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-432, 3, 1.0, &w_layer_15[k][0][0], 3, &x_even[432-offset][0], MAX_CH, beta, &x_odd[432][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*32;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-464, 3, 1.0, &w_layer_16[k][0][0], 3, &x_odd[464-offset][0], MAX_CH, beta, &x_even[464][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*16;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-480, 3, 1.0, &w_layer_17[k][0][0], 3, &x_even[480-offset][0], MAX_CH, beta, &x_odd[480][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*8;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-488, 3, 1.0, &w_layer_18[k][0][0], 3, &x_odd[488-offset][0], MAX_CH, beta, &x_even[488][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*4;
			float beta = k == 0 ? 0.0 : 1.0;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 3, L-492, 3, 1.0, &w_layer_19[k][0][0], 3, &x_even[492-offset][0], MAX_CH, beta, &x_odd[492][0], MAX_CH);
		}
		...
		for (int k = 0; k < 2; k++) {
			int offset = (1-k)*2;
			cblas_sgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 1, L-494, 3, 1.0, &w_layer_20[k][0][0], 1, &x_odd[494-offset][0], MAX_CH, 1.0, &x_even[494][0], MAX_CH);
		}
